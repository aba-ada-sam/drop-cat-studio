...
_CREATURE_SPECIES_HEAD = {
    ...
    "mollusk": "smooth shell-plated head, no distinct face, small sensory tendrils",
    ...
    "golem": "a sculpted inorganic head with no organic face, glowing carved eyes, no hair",
    "elemental": "a featureless elemental head with a glowing inner core, no organic face, no hair",
    "undead": "a gaunt skeletal face, sunken hollow eyes, exposed bone, no hair",
    "spirit": "a hollow translucent face, glowing eyes, features barely visible, no hair",
    "demonkin": "a monstrous demonic face, curved horns, sharp fangs, glowing eyes",
    "alien": "an elongated alien head, large black eyes, no hair, no human features",
    "plantfolk": "a bark-textured head with no human face, small leafy or fungal growths",
    "crystalline": "a faceted crystalline head, glowing crystal core, no organic face, no hair",
}

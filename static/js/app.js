...
import { init as initQueue, pause as pauseQueue, resume as resumeQueue } from './tab-queue.js?v=20260429a';
import { init as initFunVideos, receiveHandoff as funHandoff } from './tab-fun-videos.js?v=20260429a';

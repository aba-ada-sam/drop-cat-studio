...
import { init as initExpress, receiveHandoff as expressHandoff } from './tab-express.js?v=20260505b';
import { init as initQueue, pause as pauseQueue, resume as resumeQueue, openJobModal } from './tab-queue.js?v=20260505d';
import { init as initFunVideos, receiveHandoff as funHandoff } from './tab-fun-videos.js?v=20260505b';
import { init as initSongVideo, receiveHandoff as songVideoHandoff } from './tab-song-video.js?v=20260505d';
import { init as initBridges,   receiveHandoff as bridgesHandoff } from './tab-bridges.js?v=20260503i';
import { init as initSdPrompts, receiveHandoff as sdPromptsHandoff } from './tab-sd-prompts.js?v=20260505a';

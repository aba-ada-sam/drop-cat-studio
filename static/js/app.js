...
import { init as initImports } from './tab-imports.js?v=20260419f';
import { init as initFunVideos, receiveHandoff as funHandoff } from './tab-fun-videos.js?v=20260419f';
import { init as initBridges,   receiveHandoff as bridgesHandoff } from './tab-bridges.js?v=20260419f';
import { init as initSdPrompts, receiveHandoff as sdPromptsHandoff } from './tab-sd-prompts.js?v=20260419f';
import { init as initImageGen } from './tab-image-gen.js?v=20260419f';
import { init as initImage2Video } from './panel-image2video.js?v=20260419f';
import { init as initVideoTools  } from './panel-video-tools.js?v=20260419f';
import { init as initWildcards   } from './panel-wildcards.js?v=20260419f';
import { consumeHandoff } from './handoff.js?v=20260419f';
import { toast, apiFetch, openErrorLog } from './shell/toast.js?v=20260419f';
import { init as initGallery, refresh as refreshGallery } from './shell/gallery.js?v=20260419f';
import { open as openPalette, close as closePalette, registerItems } from './shell/command-palette.js?v=20260419f';
import './shell/ai-intent.js?v=20260419f';
import { register as registerShortcut, getShortcuts } from './shell/shortcuts.js?v=20260419f';
import { init as initPresets, promptAndSave as savePreset } from './shell/presets.js?v=20260419f';
